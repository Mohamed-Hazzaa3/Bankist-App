...
const account3 = {
  ...
  movementsDates: [
    ...
    '2018-04-01T10:17:24.185Z',
    '2018-05-08T14:11:59.604Z',
    '2018-07-26T17:01:17.194Z',
    '2019-07-28T23:36:17.929Z',
...
const account4 = {
  ...
  movementsDates: [
    ...
    '2017-04-01T10:17:24.185Z',
    '2018-05-08T14:11:59.604Z',
    '2018-07-26T17:01:17.194Z',
    '2018-07-28T23:36:17.929Z',
    '2018-08-01T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'en-UK', // de-DE
};
...
const formatMovementsDate = function (date, locale) {
  ...
  const daysPassed = calcDayesPassed(new Date(), date);
  if (daysPassed === 0) return 'Today';
  if (daysPassed === 1) return 'Yesterday';
  if (daysPassed <= 7) return `${daysPassed} dayes ago`;
...
const calcDisdplayBalance = function (acc) {
...
const ubdateUI = function (acc) {
  // Display movements
  displayMovements(currentAccount);
  // Display balance
  calcDisdplayBalance(currentAccount);
  // Display summary
